<template>
  <div>
  <el-container >
      <el-header>elementui例子</el-header>
            ...
            <el-menu :default-openeds="['1']">
              ...
              <el-submenu index="5">
                  ...
                  <el-menu-item-group>
                      ...
                      <el-menu-item index="5-4"><router-link to="/messageBox">MessageBox 弹框</router-link></el-menu-item>
      ...
      <el-footer style="height: 40px;">by Qinruqin</el-footer>
  </el-container>
  </div>
</template>
